        ...
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
            <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
                <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                    ...
                    <h2 class="text-3xl font-bold tracking-tight text-gray-900">Que tal conversarmos com um café?</h2>
                    <p class="mt-6 text-lg leading-8 text-gray-600">Tem uma ideia incrível e quer colocá-la em prática? Fala
                        comigo, vamos tirar esse projeto do papel juntos!</p>
              ...
              <dd><a class="hover:text-gray-900" href="tel:+1 (555) 234-5678">+1 (555) 234-5678</a></dd>
                        ...
                        <div class="flex gap-x-4">
                            ...
                            <dd><a class="hover:text-gray-900"
                                    href="mailto:hello@example.com">contato@mikaeloliveira.com.br</a></dd>
                        </div>
                    </dl>
                </div>
            </div>
                ...
                <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        <div>
                            ...
                            <div class="mt-2.5">
                                <input type="text" name="first-name" placeholder="David Gueta" id="first-name"
                        ...
                        <div>
                            <label for="last-name"
                                class="block text-sm font-semibold leading-6 text-gray-900">Assunto</label>
                            <div class="mt-2.5">
                                <input type="text" name="last-name" placeholder="contato para um café" id="last-name"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2.5">
                                <input type="email" name="email" placeholder="david@gmail.com" id="email"
                                    autocomplete="email"
                                    class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2.5">
                                <input type="tel" name="phone-number" placeholder="(11) 99999-9999" id="phone-number"
                                    autocomplete="tel"
                                    class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    ...
                    <div class="mt-8 flex justify-end">
                        <button type="submit"
                            class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Enviar
                            Mensagem</button>
                    </div>
                </div>
            </form>
