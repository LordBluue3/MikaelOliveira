<div class="bg-white py-24 sm:py-1">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-4xl">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Meu Blog</h2>
            <p class="mt-2 text-lg leading-8 text-gray-600">Aqui você vai encontrar histórias, conteudo sobre tecnologia
                e muito mais.</p>
