            ...
            <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                <figure class="relative isolate pt-6 sm:pt-12">
                    ...
                    <blockquote class="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                        <p>Sempre antes de dormir se faça essa pergunta, o que eu aprendi de novo hoje? Se você
                            conseguir responder isso você pode ir dormir tranquilo : )</p>
                    </blockquote>
                    <figcaption class="mt-8 text-base">
                        <div class="font-semibold text-white">Mikael Oliveira</div>
                        <div class="mt-1 text-gray-400">Back-end Devloper</div>
                    </figcaption>
                </figure>
            </div>
        </div>
